...
typedef struct JSDebuggerInfo {
    ...
    void (*transport_close_real)(JSRuntime* rt, void *udata);
...
void js_debugger_attach(
    ...
    size_t (*transport_peek)(void *udata),
    void (*transport_close)(JSRuntime* rt, void *udata),
    void (*message_handler_initializer)(JSContext* ctx, int type, void *udata),
    void *udata
);
void js_debugger_connect(JSContext *ctx, const char *address, void (*debugger_attach_notify)(JSContext* ctx, int type, void *udata));
void js_debugger_wait_connection(JSContext *ctx, const char* address, void (*debugger_attach_notify)(JSContext* ctx, int type, void *udata));
